...
import jahirfiquitiva.apps.textdrawable.models.DrawableProvider;
import jahirfiquitiva.libs.textdrawable.TextDrawable;
import jahirfiquitiva.libs.textdrawable.util.ColorGenerator;
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        private void updateCheckedState(ViewHolder holder, ListData item) {
            if (item.isChecked) {
                ...
                TextDrawable drawable = mDrawableBuilder.build(String.valueOf(item.data.charAt(0)),
